...
* `components/print/print-rapor.tsx` (P0: Hapus fallback hafalan hardcoded "Ali 'Imran: 1-20" -> "-", hitung predikat dinamis kepesantrenan via `konversiPredikatNilai`).
...
- [x] `npm test` (326 tests lulus, 111 suites, 0 failures)
