...
export const DEMO_ACCOUNTS: Record<Role, DemoAccount> = {
  KS: {
    ...
    name: "Ust. H. Ahmad Fauzi, Lc., M.Pd.",
  ...
  MT: {
    ...
    password: "password123",
    name: "Ust. Zulkifli Al-Hafizh",
    roleTitle: "Musyrif Tahfizh",
  ...
  PH: {
    ...
    password: "password123",
    name: "Ust. Bilal Habibi, S.Ag.",
    roleTitle: "Pembina Halaqoh",
