...
import { ROLE_LABELS, Role, DEMO_ACCOUNTS } from "@/types/auth";
import {
  Lock,
  User as UserIcon,
  Sparkles,
...
export default function LoginPage() {
  ...
  const [roleCategoryFilter, setRoleCategoryFilter] = useState<"ALL" | "LEADERSHIP" | "TAHFIZH" | "WALI">("ALL");
        ...
        <div className="lg:col-span-7 space-y-4">
          <Card rounded="3xl" className="shadow-lg shadow-slate-200/50 p-6 bg-white border border-slate-200/80">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
              ...
              <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-2xl shrink-0 text-[11px]">
                <button
                  type="button"
