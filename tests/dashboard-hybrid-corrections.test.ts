    ...
    const mockSantriList: DashboardMusyrifTahfizhSantriItem[] = [
      {
        ...
        poinPelanggaran: 0,
        sudahSetorHariIni: false,
        completedJuzCanonical: 10,
        targetDailyMufarJuz: 0.5,
        actualDailyMufarJuz: 0,
        weeklySabaqProgress: { status: "BELUM_TERCAPAI", target: 5, actual: 2, targetLabel: "5 Halaman", remaining: 3, percentage: 40 },
        statusTahfizhHariIni: {
          sabaq: "BELUM_SELESAI",
          sabqi: "TIDAK_BERLAKU",
          manzil: "BELUM_SELESAI",
          mufar: "BELUM_SELESAI",
          isHariEfektif: true,
          sudahSetorHariIni: false,
        },
        mufarProgressLabel: "0/0.5 Juz",
        needsAttention: true,
        attentionReasons: ["Belum setor Sabaq hari ini"],
      },
      {
        id: "SAN-UUID-002",
        nis: "NIS-002",
        ...
        poinPelanggaran: 0,
        sudahSetorHariIni: true,
        completedJuzCanonical: 15,
        targetDailyMufarJuz: 1,
        actualDailyMufarJuz: 1,
        weeklySabaqProgress: { status: "TERCAPAI", target: 5, actual: 5, targetLabel: "5 Halaman", remaining: 0, percentage: 100 },
        statusTahfizhHariIni: {
          sabaq: "SELESAI",
          sabqi: "SELESAI",
          manzil: "SELESAI",
        ...
        mufarProgressLabel: "Tercapai (1/1 Juz)",
