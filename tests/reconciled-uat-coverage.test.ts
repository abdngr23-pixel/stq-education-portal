    ...
    const mockSessions: EducationSessionReadDTO[] = [
      {
        ...
        plannedEndTime: "09:50",
        programLevel: 1,
        cohortId: "coh-1",
        cohortCode: "TINGKAT_1",
        cohortLabel: "Tingkat 1",
        cohortTahunAjaran: "2026/2027",
        genderGroup: "PUTRA",
        jp: 2,
        semesterMeetingNumber: 1,
        // Legacy technical DTO field; non-canonical per ORR-131 / DIR-2026-025 (no owner theory/project/inquiry phase)
        pblPhase: null,
        pblBlockNumber: 1,
        pblMetadata: null,
